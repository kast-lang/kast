...
@syntax "core:fn" 7 @wrap never = raw_fn=("fn" " ")? call_convention=("@call" " " _: >= 5000 " ")? async=("async" _=("=" value)? " ")? arg " " context=("with" " " _ " ")? result=("->" " " _ " " _=("with" " " context " ")?)? "=>" " " body;
...
@syntax "Box" 1000 @wrap never = "Box" "[" T:any "]";
