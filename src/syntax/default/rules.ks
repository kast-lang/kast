...
@syntax "core:fn_type" 6.5 @wrap never = arg " " context_args=("with" " " _ " ")? "->" " " result context_result=("with" " " _ " ")?;

@syntax "core:fn" 7 @wrap never = arg " " context_args=("with" " " _ " ")? result=("->" " " _ " " context_result=("with" " " _ " ")?)? "=>" " " body;
